...
================================================================================ -->
  <head>
    ...
    <title>Cadastre-se! | Agenda Digital</title>
    <!-- Favicons-->
              ...
              <form class="login-form" method="POST" action="{{ route('register') }}">
                ...
                <div class="row">
                  <div class="input-field col s12 center">
                    <h4>Cadastre-se!</h4>
                    <p class="center">Faça parte de nossa comunidade já!</p>
                  </div>
                </div>
                <div class="row margin">
                  <div class="input-field col s12">
                    <i class="material-icons prefix pt-5">person_outline</i>
                    <label for="username" class="center-align">Nome</label>
                ...
                <div class="row margin">
                    <div class="input-field col s12">
                        <i class="material-icons prefix pt-5">lock_outline</i>
                        <label for="password-again">Confirme a Senha</label>
                ...
                <div class="row">
                  <div class="input-field col s12">
                    <button type="submit" class="btn waves-effect waves-light col s12">{{ __('Cadastrar') }}</button>
                  </div>
                  <div class="input-field col s12">
                    <p class="margin center medium-small sign-up">Já tem uma conta? <a href="{{ route('login') }}">Login</a></p>
                  </div>
                </div>
              </form>
            </div>
